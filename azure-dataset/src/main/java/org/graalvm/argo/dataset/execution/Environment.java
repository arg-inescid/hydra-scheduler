...
public class Environment {
    ...
    // Python
    public static final String GV_PY_HELLOWORLD_CODE = HOST_ADDRESS + "/apps/gv-py-hello-world.so";
    ...
    public static final String GV_PY_UPLOADER_CODE = HOST_ADDRESS + "/apps/gv-py-uploader.so";
    ...
    public static final String GV_JS_UPLOADER_CODE = HOST_ADDRESS + "/apps/gv-js-uploader.so";
    ...
    public static final String GV_JV_FILEHASHING_CODE = HOST_ADDRESS + "/apps/gv-jv-file-hashing.so";
    public static final String GV_JV_FILEHASHING_ENTRYPOINT = "com.filehashing.FileHashing";
    public static final String GV_JV_HTTPREQUEST_CODE = HOST_ADDRESS + "/apps/gv-jv-httprequest.so";
    ...
    // JavaScript
    public static final int JS_HELLOWORLD_MEMORY = 1024;
    public static final int JS_UPLOADER_MEMORY = 1024;
    public static final int JS_DYNAMICHTML_MEMORY = 1024;
    // Java
